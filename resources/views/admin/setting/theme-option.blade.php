...
<?php
    $data_seo = array(
    'title' => 'Theme Option | '.$settings->where('type', 'seo_title')->first()->value,
    'keywords' => $settings->where('type', 'seo_keyword')->first()->value,
    'description' => $settings->where('type', 'seo_description')->first()->value,
    'og_title' => 'Theme Option | '.$settings->where('type', 'seo_title')->first()->value,
              ...
              <div class="card-body">
              	<form action="{{route('admin.storeThemeOption')}}" method="POST" id="frm-theme-option">
								...
								switch($option_choise):
									case "line":
											echo '<div class="group_item_theme clear">
		                      					...
		                      					<div class="right_item_theme right_genate"><input type="text" class="regular-text" placeholder="Please enter Value Field" name="header_option_values_line[]" value="'.htmlspecialchars($option_value).'" /><input type="button" class="button button-secondary tbl_button_delete_clean" value="Delete" name="delete_tbl"></div>
		                       				</div>';
									break;
									case "muti_line":
										echo '<div class="group_item_theme clear">
		                       					...
		                       					<div class="right_item_theme right_genate"><textarea class="regular-area" name="header_option_values_muti_line[]" cols="5" rows="5">'.htmlspecialchars($option_value).'</textarea><input type="button" class="button button-secondary tbl_button_delete_clean" value="Delete" name="delete_tbl"></div>
		                       				 </div>';
									break;
									default:
								endswitch;
	             	...
	             	<div class="posts_tbl_setting clear text-center">
	            		...
	            		<p><b>Use:</b> <i style="color: #FF0000;">\App\Libraries\Helpers::get_option('value');</i></p>
	             	</div>
             	</form>
              </div>
              <!-- /.card-body -->
