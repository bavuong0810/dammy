...
<section class="content">
  	<div class="container-fluid">
        <form action="{{route('admin.storePostCategory')}}" method="POST" id="frm-create-category" enctype="multipart/form-data">
            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file" name="thumbnail_file" class="custom-file-input"
                                               accept="image/*" id="thumbnail_file" style="display: none;">
