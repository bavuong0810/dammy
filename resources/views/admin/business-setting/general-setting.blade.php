...
@section('seo')
    <?php
    $data_seo = array(
        'title' => 'Cài đặt chung | ' . $settings->where('type', 'seo_title')->first()->value,
        'keywords' => $settings->where('type', 'seo_keyword')->first()->value,
        'description' => $settings->where('type', 'seo_description')->first()->value,
        'og_title' => 'Cài đặt chung | '.$settings->where('type', 'seo_title')->first()->value,
                                ...
                                <div class="bg-box mb-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="seo_title"
                                               ...
                                               value="{{ $settings->where('type', 'seo_title')->first()->value }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="seo_description" id="seo_description"
                                                          ...
                                                          cols="5" rows="5">{!! $settings->where('type', 'seo_description')->first()->value !!}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="seo_keyword" id="seo_keyword"
                                                          ...
                                                          cols="5" rows="5">{!! $settings->where('type', 'seo_keyword')->first()->value !!}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <?php
                                        $seo_image = $settings->where('type', 'seo_image')->first()->value;
                                        if ($seo_image == '') {
