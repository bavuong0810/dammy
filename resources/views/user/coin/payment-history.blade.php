...
$data_seo = array(
    'title' => 'Lịch sử nạp xu | ' . $seo_title,
    'keywords' => '',
    'description' => $seo_description,
    'og_title' => 'Lịch sử nạp xu | ' . $seo_title,
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Lịch sử nạp xu</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        <div class="position-relative">
                            <form action="{{ route('user.paymentHistory') }}" method="GET">
