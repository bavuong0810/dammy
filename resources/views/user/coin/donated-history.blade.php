...
$data_seo = array(
    'title' => 'Lịch sử nhận Donate | ' . $seo_title,
    'keywords' => '',
    'description' => $seo_description,
    'og_title' => 'Lịch sử nhận Donate | ' . $seo_title,
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Lịch sử nhận Donate</li>
                        </ol>
                    </nav>
                </div>
            </div>
